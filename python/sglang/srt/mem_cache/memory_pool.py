...
class MambaPool:
    # Per-request side states riding on this pool's slot lifecycle (see
    # ple_state_pool.SlotIndexedState). register_slot_state binds an
    # instance-level list.
    ...
    def load_cpu_copy(self, mamba_cache_cpu, indices):
        siblings_cpu = None
        if self._slot_siblings:
            conv_cpu, temporal_cpu, siblings_cpu = mamba_cache_cpu
        else:
...
class HybridLinearKVPool(KVCache):
    ...
    def __init__(
        ...
        enable_memory_saver: bool = False,
        enable_kvcache_transpose: bool = False,
