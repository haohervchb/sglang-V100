...
class CompressedTensorsWNA16MoE(CompressedTensorsMoEScheme):
    ...
    def __init__(
        ...
        # The checkpoint can target only expert projection FQNs/regexes and
        # therefore have no literal "Linear" scheme. get_moe_scheme already
        # resolved the correct per-layer scheme, so use it directly.
        config = weight_quant
