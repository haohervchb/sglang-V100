...
def _make_text_linear(
    ...
    *,
    ...
    if use_weight_only_fp8:
        raise ValueError(
            "Qwen3-VL weight-only FP8 is unavailable in the V100 build; "
            "use v100_w8a16 or unquantized FP16"
        )
...
class Qwen3VLTextAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if not isinstance(self.o_proj, Qwen3VLRowParallelLinear):
...
class Qwen3VLTextMLP(nn.Module):
    ...
    def forward(self, x):
        ...
        if not isinstance(self.down_proj, Qwen3VLRowParallelLinear):
